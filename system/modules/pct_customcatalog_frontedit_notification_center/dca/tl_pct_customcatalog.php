 ...
 * Config
 */
$GLOBALS['TL_DCA'][$objDcaHelper->getTable()]['config']['onload_callback'][] = array('tl_pct_customcatalog_pct_customcatalog_frontedit_notification_center', 'modifyDca');
...
(
	...
	(
		...
		'search'          		=> true,
		'inputType'       		=> 'select',
		'options_callback'		=> array('tl_pct_customcatalog_pct_customcatalog_frontedit_notification_center','getNotifications'),
		'eval'            		=> array('tl_class'=>'','includeBlankOption'=>true,'submitOnChange'=>true,'chosen'=>true),
		'sql'			  		=> "int(10) NOT NULL default '0'",
	),
	'customcatalog_edit_notification_attributes' => $GLOBALS['TL_DCA'][$objDcaHelper->getTable()]['fields']['list_fields'],
));

$GLOBALS['TL_DCA'][$objDcaHelper->getTable()]['fields']['customcatalog_edit_notification_attributes']['inputType'] = 'checkboxWizard';
 ...
 */
class tl_pct_customcatalog_pct_customcatalog_frontedit_notification_center extends \Backend
{
	/**
	 * Modify the dca
	 * @param object
	...
	public function modifyDca($objDC)
	{
		...
		{
			$objDC->activeRecord = \PCT\CustomElements\Models\CustomCatalogModel::findByPk($objDC->id);
		}
